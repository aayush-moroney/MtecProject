function output = RandomWalkRank(W, lambda_value, alpha_value, r,vertex,range,regularizer_const,NNodes,metaData)
%% Input arguments:
...
%     trans = sparse(cell2mat(normTrans));
    Pt_new = (1-lambda_value) * r + lambda_value * Pt_new * W0;  
    temp = 0;
